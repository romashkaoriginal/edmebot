...
const diagnostic = [
  { id: "d1", topic: "fractions", prompt: "Сократи дробь 12/18 до несократимой.", options: ["2/3", "3/4", "6/9", "4/6"], correct: 0 },
  { id: "d2", topic: "equations", prompt: "Реши уравнение: 2x + 6 = 14. Чему равен x?", options: ["2", "4", "6", "10"], correct: 1 },
  { id: "d3", topic: "percents", prompt: "Сколько будет 20% от 150?", options: ["20", "30", "45", "50"], correct: 1 },
  { id: "d4", topic: "geometry", prompt: "Сумма углов треугольника равна…", options: ["90°", "180°", "270°", "360°"], correct: 1 },
  { id: "d5", topic: "powers", prompt: "Чему равно 2³?", options: ["6", "8", "9", "16"], correct: 1 },
  { id: "d6", topic: "wordproblems", prompt: "В корзине 24 яблока. Треть отдали. Сколько осталось?", options: ["8", "12", "16", "18"], correct: 2 },
  { id: "d7", topic: "fractions", prompt: "Что больше: 3/5 или 2/3?", options: ["3/5", "2/3", "равны", "нельзя сравнить"], correct: 1 },
  { id: "d8", topic: "equations", prompt: "Реши: x/3 = 5. Чему равен x?", options: ["8", "15", "2", "5/3"], correct: 1 },
  { id: "d9", topic: "percents", prompt: "Цена 800 ₽ выросла на 25%. Новая цена?", options: ["1000 ₽", "825 ₽", "1200 ₽", "900 ₽"], correct: 0 },
  { id: "d10", topic: "wordproblems", prompt: "Поезд идёт 300 км за 4 ч. Скорость?", options: ["60 км/ч", "75 км/ч", "80 км/ч", "1200 км/ч"], correct: 1 },
];

const taskBank = [
  {
    id: "t1", topic: "fractions", difficulty: "easy", prompt: "Сложи дроби: 1/4 + 1/4",
  ...
  {
    id: "t2", topic: "fractions", difficulty: "medium", prompt: "Сложи дроби: 1/2 + 1/3",
  ...
  {
    id: "t3", topic: "equations", difficulty: "medium", prompt: "Реши уравнение: 3x − 7 = 8",
  ...
  {
    id: "t4", topic: "percents", difficulty: "easy", prompt: "Сколько будет 10% от 250?",
  ...
  {
    id: "t5", topic: "wordproblems", difficulty: "hard", prompt: "Велосипедист проехал 45 км за 3 часа. С какой скоростью он должен ехать, чтобы проехать те же 45 км за 2 часа?",
  ...
  {
    id: "t6", topic: "geometry", difficulty: "medium", prompt: "Два угла треугольника равны 50° и 60°. Чему равен третий угол?",
...
const shopItems = [
  { id: "s1", category: "food", name: "Ягоды", price: 20, icon: "🫐" },
  { id: "s2", category: "food", name: "Орешки", price: 15, icon: "🌰" },
  { id: "s3", category: "look", name: "Шарф", price: 60, icon: "🧣" },
  { id: "s4", category: "look", name: "Очки", price: 80, icon: "🕶️" },
  { id: "s5", category: "look", name: "Шапка", price: 70, icon: "🎩" },
