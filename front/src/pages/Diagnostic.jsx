    ...
    <div className="diag">
      <Card className="diag__intro" pad="lg">
        ...
        <p className="diag__lead">
          Короткий тест{profile.subject ? ` по предмету «${profile.subject}»` : ""}, чтобы понять
          твой уровень и собрать персональную карту знаний. Результат можно передать репетитору.
        </p>
