// Mock data mirroring the future backend. All non-AI. Rule-based selection.

export const SUBJECT = "Математика";

// Knowledge map from the diagnostic test: status green|yellow|red
export const topics = [
  { id: "fractions", name: "Дроби", status: "red", mastery: 34 },
  { id: "equations", name: "Уравнения", status: "yellow", mastery: 61 },
  { id: "geometry", name: "Геометрия: углы", status: "green", mastery: 88 },
  { id: "percents", name: "Проценты", status: "yellow", mastery: 55 },
  { id: "powers", name: "Степени", status: "green", mastery: 82 },
  { id: "wordproblems", name: "Текстовые задачи", status: "red", mastery: 41 },
];

// Diagnostic questions (module 1)
export const diagnostic = [
  {
    id: "d1",
    topic: "fractions",
    prompt: "Сократи дробь 12/18 до несократимой.",
  ...
  },
  {
    id: "d2",
    topic: "equations",
    prompt: "Реши уравнение: 2x + 6 = 14. Чему равен x?",
    options: ["2", "4", "6", "10"],
    correct: 1,
  },
  {
    id: "d3",
    topic: "percents",
    prompt: "Сколько будет 20% от 150?",
    options: ["20", "30", "45", "50"],
    correct: 1,
  },
  {
    id: "d4",
    topic: "geometry",
    prompt: "Сумма углов треугольника равна…",
  ...
  },
  {
    id: "d6",
    topic: "wordproblems",
    prompt: "В корзине 24 яблока. Треть отдали. Сколько осталось?",
    options: ["8", "12", "16", "18"],
    correct: 2,
  },
  {
  ...
  },
  {
    id: "d8",
    topic: "equations",
    prompt: "Реши: x/3 = 5. Чему равен x?",
    options: ["8", "15", "2", "5/3"],
    correct: 1,
  },
  {
    id: "d9",
    topic: "percents",
    prompt: "Цена 800 ₽ выросла на 25%. Новая цена?",
    options: ["1000 ₽", "825 ₽", "1200 ₽", "900 ₽"],
    correct: 0,
  },
  {
    id: "d10",
    topic: "wordproblems",
    prompt: "Поезд идёт 300 км за 4 ч. Скорость?",
    options: ["60 км/ч", "75 км/ч", "80 км/ч", "1200 км/ч"],
    correct: 1,
  },
];

// Practice task bank (modules 2-4). Each task carries a hint chain (never the answer).
export const taskBank = [
  {
    ...
    correct: 0,
    explanation:
      "Знаменатели одинаковые (4), поэтому складываем только числители: 1 + 1 = 2. Получаем 2/4, а это то же самое, что 1/2.",
    hints: [
      "Посмотри на знаменатели — они одинаковые. Что тогда нужно сделать только с числителями?",
      "Сложи числители: 1 + 1. Знаменатель оставь прежним, потом сократи результат.",
    ],
  ...
  },
  {
    ...
    topic: "fractions",
    difficulty: "medium",
    prompt: "Сложи дроби: 1/2 + 1/3",
    options: ["2/5", "5/6", "1/6", "2/6"],
    correct: 1,
    explanation:
      "Знаменатели разные. Приводим к общему знаменателю 6: 1/2 = 3/6, 1/3 = 2/6. Складываем: 3/6 + 2/6 = 5/6.",
    hints: [
      "Знаменатели разные (2 и 3). Найди их наименьший общий знаменатель.",
      "Общий знаменатель — 6. Приведи обе дроби к нему, потом сложи числители.",
    ],
  ...
  },
  {
    ...
    topic: "equations",
    difficulty: "medium",
    prompt: "Реши уравнение: 3x − 7 = 8",
    options: ["3", "5", "15", "1"],
    correct: 1,
    explanation:
      "Переносим −7 вправо со сменой знака: 3x = 8 + 7 = 15. Делим обе части на 3: x = 5.",
    hints: [
      "Сначала перенеси свободное число вправо. Не забудь сменить знак.",
      "Получишь 3x = 15. Осталось разделить обе части на коэффициент при x.",
    ],
  ...
  },
  {
    ...
    topic: "percents",
    difficulty: "easy",
    prompt: "Сколько будет 10% от 250?",
    options: ["10", "25", "50", "2.5"],
    correct: 1,
    explanation: "10% — это одна десятая. Делим 250 на 10 = 25.",
    hints: [
      "10% — это то же самое, что разделить число на 10.",
      "Просто убери один ноль или раздели 250 на 10.",
    ],
  ...
  },
  {
    ...
    difficulty: "hard",
    prompt:
      "Велосипедист проехал 45 км за 3 часа. С какой скоростью он должен ехать, чтобы проехать те же 45 км за 2 часа?",
    options: ["15 км/ч", "22.5 км/ч", "30 км/ч", "90 км/ч"],
    correct: 1,
    explanation:
      "Скорость = расстояние ÷ время. Чтобы проехать 45 км за 2 часа: 45 ÷ 2 = 22.5 км/ч.",
    hints: [
      "Вспомни формулу: скорость = расстояние ÷ время. Первые данные (3 часа) здесь — отвлекающие.",
      "Нужное время — 2 часа, расстояние то же (45 км). Раздели 45 на 2.",
    ],
  ...
  },
  {
    ...
    topic: "geometry",
    difficulty: "medium",
    prompt: "Два угла треугольника равны 50° и 60°. Чему равен третий угол?",
    options: ["60°", "70°", "80°", "110°"],
    correct: 1,
    explanation: "Сумма углов треугольника = 180°. Третий угол = 180 − 50 − 60 = 70°.",
    hints: [
      "Чему всегда равна сумма всех трёх углов треугольника?",
      "Из 180° вычти два известных угла.",
    ],
...
export const homework = [
  {
    ...
    description: "Реши №4–12 на стр. 48. Обрати внимание на приведение к общему знаменателю.",
    due: addDays(1),
    status: "active",
    materials: [{ label: "Памятка: общий знаменатель", url: "#" }],
  },
  {
    id: "hw2",
    topic: "Уравнения",
    title: "Линейные уравнения",
    description: "Составь и реши 5 уравнений по задачам из карточки.",
    due: addDays(3),
    status: "active",
    materials: [],
  },
  {
    ...
    description: "Тренажёр «Проценты», уровень 2. Минимум 10 заданий.",
    due: addDays(-1),
    status: "overdue",
    materials: [],
  },
  {
    ...
    description: "Повтори теорему о сумме углов и реши задачи 1–6.",
    due: addDays(-4),
    status: "done",
    materials: [],
  },
...
// Achievements (modules 5, 9). tier: bronze | silver | gold | diamond
...
// Selectable pet species (module 6)
export const petSpecies = [
  { id: "fox", name: "Лиса" },
  { id: "raccoon", name: "Енот" },
  { id: "squirrel", name: "Белка" },
  { id: "owl", name: "Совёнок" },
  { id: "cat", name: "Котёнок" },
];

// Shop items for the pet (module 6).
// food items carry `treat` (rendered flying into the pet during the eat animation).
// look items carry `slot` + `accessory` (a real SVG layer worn on the pet).
